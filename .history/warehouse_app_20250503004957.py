...
from views.settings_dialog import SettingsDialog  # Add this import statement
...
class WarehouseApp:
    ...
    def __init__(self, root, user):
        ...
        # Log login
        self.log(f"User '{self.user}' logged in GUI")
    ...
    def setup_warehouse(self):
        ...
        # Tag warehouse with current user for view-side logging
        self.warehouse.user = self.user
    ...
    def create_menu(self):
        ...
        logs_menu.add_command(label="View Logs", command=self.open_logs)
    ...
    def open_logs(self):
        ...
        self.log("Viewed logs")
        LogView(self.root, self.warehouse.data_storage)
    
    def log(self, action):
        """Helper to append a log row."""
        self.warehouse.data_storage.save_log(self.user, action)
    ...
    def show_about(self):
        ...
        ttk.Label(about_window, text="© 2025 Colin Ferreira").pack(pady=5)
